...
void testReplace()
{
    ...
    assert(map.add(1, 10) == NULL_TVALUE);
    assert(map.add(2, 20) == NULL_TVALUE);
    assert(map.add(3, 30) == NULL_TVALUE);

    map.replace(2, 20, 25);
    assert(map.search(2) == 25);

    map.replace(2, 20, 30);
    assert(map.search(2) == 25);

    map.replace(4, 40, 45);
    assert(map.search(4) == NULL_TVALUE);

    map.replace(1, 10, 15);
    assert(map.search(1) == 15);

    map.replace(3, 30, 35);
    assert(map.search(3) == 35);
    ...
    map.replace(1, 15, 50);
    assert(map.search(1) == 50);

    std::cout << "All tests passed for replace functionality." << std::endl;
