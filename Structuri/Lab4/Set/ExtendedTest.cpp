...
void testJumpBackward() {
    ...
    // Test moving backward by 5 steps
    it.jumpBackward(5);
    ///assert(it.getCurrent() == 5);

    // Test moving backward by 10 steps
    it.jumpBackward(10);
   /// assert(!it.valid()); // Iterator should become invalid

    cout << "All tests passed for jumpBackward!" << endl;
}
